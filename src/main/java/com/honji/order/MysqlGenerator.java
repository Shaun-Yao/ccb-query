...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:sqlserver://10.10.10.163;databaseName=finance-test");
...
/*
        ...
        final String str = projectPath + "/mybatis-plus-sample-generator/src/main/resources/mapper/"
                + pc.getModuleName() + "/";
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return str + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
...
*/
        ...
        strategy.setSuperEntityClass("com.honji.order.BaseEntity");
